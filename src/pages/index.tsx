...
const LoadingSpinner = () => (
  <motion.div
    ...
    className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-white dark:from-blue-950 dark:via-blue-900 dark:to-gray-900"
  >
            ...
            {FEATURED_IMAGES.map((image, index) => (
              <CarouselItem key={index}>
                <motion.div
                  ...
                  className="relative aspect-video overflow-hidden rounded-lg shadow-blue-200/50 dark:shadow-blue-500/20 shadow-lg"
                >
                  <img
                    src={image.src}
                    alt={image.alt}
...
const Index = (): JSX.Element => {
  return (
    <motion.div
      ...
      className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-gray-900 dark:to-blue-900"
    >
