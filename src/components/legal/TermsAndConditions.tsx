    ...
    <Card className="p-6 max-w-4xl mx-auto bg-white/95 backdrop-blur-sm">
      <ScrollArea className="h-[70vh] pr-4">
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-primary">Términos y Condiciones del Servicio</h2>
          ...
          <section className="space-y-4 bg-yellow-50/50 p-4 rounded-lg border border-yellow-200">
            ...
            <div className="space-y-2 text-gray-700">
              <p>
                <strong>2.1.</strong> El cliente tiene la obligación de informar correctamente sobre la necesidad de maniobras especiales al momento de solicitar el servicio.
              </p>
              <p>
                <strong>2.2.</strong> En caso de que el cliente no haya declarado la necesidad de maniobras especiales al momento de la solicitud:
              </p>
          ...
          <section className="space-y-4 bg-red-50/50 p-4 rounded-lg border border-red-200">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p>
                <strong>3.2.</strong> Esta política aplica tanto al cargo base como a cualquier cargo adicional por maniobras especiales.
              </p>
            </div>
          </section>
